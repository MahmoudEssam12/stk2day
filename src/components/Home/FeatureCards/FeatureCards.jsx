...
function FeatureCards() {
  ...
  return (
    <section className={styles.feature_cards}>
      ...
      <Card image="/images/icon-2.png" text={t("home:storing_feature")} />
      <Card image="/images/icon-3.png" text={t("home:prices_feature")} />
      <Card image="/images/icon-4.png" text={t("home:payment_feature")} />
      <Card image="/images/icon-5.png" text={t("home:support_feature")} />
      <Card image="/images/icon-6.png" text={t("home:dashboard_feature")} />
      {/* <FeatureCard />
      <FeatureCard
        color="light_blue"
